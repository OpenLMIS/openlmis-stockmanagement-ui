...
* [OLMIS-8362](https://openlmis.atlassian.net/browse/OLMIS-8362): Login now waits until the stock card summaries of every supported program are cached, so Issue, Receive and Adjustment open offline right after login instead of failing until the summaries finish loading in the background.
