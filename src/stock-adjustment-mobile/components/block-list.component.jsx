...
const BlockList = ({data, dataToDisplay, headerToDisplay}) => {
    return (
        <div className="react-block-list-container" style={{width: "100%"}}>
            <div className="react-block-list-content">
                {data.map((row, i) => {
                    return (
                        <div className="react-block-list-container-row" style={{height: "160px", width: "100%",  borderBottom: "1px solid #dbdada", borderTop: "1px solid #dbdada"}}>    
