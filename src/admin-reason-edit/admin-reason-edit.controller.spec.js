...
describe('AdminReasonEditController', function() {

    var vm, reasonTypes, reasonCategories, $controller, programs, reason, $rootScope, facilityTypes,
        ProgramDataBuilder, FacilityTypeDataBuilder, ReasonDataBuilder, reasons, availableTags,
        REASON_CATEGORIES, REASON_TYPES, $q, programsMap, facilityTypesMap;
    ...
    beforeEach(function() {
        ...
        vm = $controller('AdminReasonEditController', {
