...
(function() {
    ...
    run.$inject = ['loginService', 'currentUserHomeFacilityService'];

    function run(loginService, currentUserHomeFacilityService) {
        ...
        loginService.registerPostLogoutAction(function() {
            return currentUserHomeFacilityService.clearCache();
        });
